...
/// <summary>
/// Response converter for XAI API
/// </summary>
internal static class XAIResponseConverter
{
    public static LlmResponse ConvertToLlmResponse(XAIResponse response)
    {
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        {
            XAIStreamChunk? streamChunk = null;
            
            try
            {
                streamChunk = JsonSerializer.Deserialize<XAIStreamChunk>(chunk);
            }
            catch (JsonException)
            {
                continue;
