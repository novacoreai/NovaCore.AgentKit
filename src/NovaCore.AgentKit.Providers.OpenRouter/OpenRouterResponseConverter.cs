...
/// <summary>
/// Response converter for OpenRouter API
/// </summary>
internal static class OpenRouterResponseConverter
{
    public static LlmResponse ConvertToLlmResponse(OpenRouterResponse response)
    {
    ...
    public static async IAsyncEnumerable<LlmStreamingUpdate> StreamResponseAsync(
        OpenRouterRestClient restClient,
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        {
            OpenRouterStreamChunk? streamChunk = null;
            
            try
            {
                streamChunk = JsonSerializer.Deserialize<OpenRouterStreamChunk>(chunk);
            }
            catch (JsonException)
            {
                continue;
