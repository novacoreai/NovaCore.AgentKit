...
{
    /// <summary>Claude Sonnet 4.5 (September 2025) - Latest and most capable model</summary>
    public const string ClaudeSonnet45 = "claude-sonnet-4-5-20250929";

    /// <summary>Claude Haiku 4.5 (October 2025) - Powerful reasoning model</summary>
    public const string ClaudeHaiku45 = "claude-haiku-4-5-20251001";

    /// <summary>Claude Sonnet 4 (May 2025) - Enhanced capabilities</summary>
    public const string ClaudeSonnet4 = "claude-sonnet-4-20250514";

    /// <summary>Claude Sonnet 3.7 (Feb 2025) - Previous generation</summary>
