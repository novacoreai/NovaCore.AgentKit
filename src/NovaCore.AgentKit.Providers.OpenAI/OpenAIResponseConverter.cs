...
/// <summary>
/// Response converter for OpenAI API
/// </summary>
internal static class OpenAIResponseConverter
{
    public static LlmResponse ConvertToLlmResponse(OpenAIResponse response)
    {
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        {
            OpenAIStreamChunk? streamChunk = null;
            
            try
            {
                streamChunk = JsonSerializer.Deserialize<OpenAIStreamChunk>(chunk);
            }
            catch (JsonException)
            {
                continue;
